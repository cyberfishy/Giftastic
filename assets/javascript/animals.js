...
var favorites = [];
var apiKey = "&api_key=aAqd4JZDwbAi1oJmL4MoqlBrhWuhkWgb";
var queryAnimal;
var offset = 0;
var loadMore = 25;
var clickCount = 1;
...
//Dislay all predefined animals in array
function displayArr () {
...
//Save to favorites on localStorage
...
//clear localStorage favs
//(".btn").on('click', function () {
//   window.localStorage.removeItem('localStorageFav');
